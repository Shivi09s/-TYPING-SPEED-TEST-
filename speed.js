...
let quote = "It takes intelligence to recognize intelligence, or the lack of it. Dive deep into AI, but always keep a lifeline tethered to human empathy. In the dance of innovation, let AI lead the steps, but ensure humanity chooses the song.";
let time = 60;
let timer = "";
let mistakes = 0;
